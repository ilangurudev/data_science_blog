...
#### Word usage that reflects personalities better
...
Using the same concept of tf-idf we can now find out which emojis characterise people better than raw counts.
```{r}
df_emoji_split %>% 
...
```{r echo=FALSE}
"Any comments, feedback or suggestions are, as people say, 😍😍😍." %>% cat() 
```
