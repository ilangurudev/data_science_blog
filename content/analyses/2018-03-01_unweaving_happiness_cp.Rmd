...
```{r fig.width=12, fig.height=9,message=FALSE,fig.align='left', cache=TRUE}
plt_year_happiness <- 
  df_happiness %>% 
  filter(year > 2005) %>% 
...
```{r fig.width=10, fig.height=8,message=FALSE, cache=TRUE}
plt_std_happiness <- 
  df_happiness %>% 
  filter(year == 2017) %>% 
...
```{r fig.width=12, fig.height=9,message=FALSE, cache=TRUE}
...
```{r fig.width=12, fig.height=10, message=FALSE, cache=TRUE}
plt_gdp_happiness <- 
...
```{r fig.width=11.5, fig.height=9,message=FALSE, cache=TRUE}
df_happiness %>% 
...
```{r fig.width=7, fig.height=7,message=FALSE, cache=TRUE}
