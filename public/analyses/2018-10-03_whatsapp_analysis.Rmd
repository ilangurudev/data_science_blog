...
Now let's put an emoji on the face using tf-idf. These emojis characterize the members better than the count. 
```{r}
df_emoji_split %>% 
...
![](/analyses/2018-10-03_whatsapp_analysis_files/sentiment.png)

Now that we know what we can do, let's calculate the overall sentiment scores
```{r}
df_sentiment <- 
  df_chats %>% 
